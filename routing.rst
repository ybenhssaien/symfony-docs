...
.. caution::
    ...
    If you define multiple PHP class per file, only the first declared class is taken, defining one PHP class per file it a good practise, visit `PSR-4 <https://www.php-fig.org/psr/psr-4/>`_ for more details.
